...
class TestUser(TestCase):
    ...
    def test_all_notifications_function(self):
        ...
        Notification.objects.create(
            user=self.student_app_user,
            message="New course material uploaded for Test Course by teacher_1",
        )
        # Login as a student
        self.client.login(username="student_1", password="abcd")
        ...
        self.assertContains(
            response, "New course material uploaded for Test Course by teacher_1"
        )
    ...
    def test_edit_profile_function(self):
        ...
        response = self.client.post(
            "/user/profile/edit/",
            {"real_name": "Updated Student One", "bio": "Updated Bio"},
        )
        # Check if the page redirects correctly
        self.assertEqual(response.status_code, 302)
