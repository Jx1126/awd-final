...
class Course(models.Model):
    ...
    created_by = models.ForeignKey(
        AppUser, on_delete=models.CASCADE, related_name="created_by"
    )
    enrolled_students = models.ManyToManyField(
        AppUser, blank=True, related_name="enrolled_students"
    )
...
class CourseFeedback(models.Model):
    ...
    student = models.ForeignKey(
        AppUser, on_delete=models.CASCADE, related_name="student_feedbacks"
    )
...
class CourseMaterial(models.Model):
    ...
    uploaded_by = models.ForeignKey(
        AppUser, on_delete=models.CASCADE, related_name="uploaded_by"
    )
